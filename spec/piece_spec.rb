  ...
  context 'moves and attacks' do
    context 'new white pawn' do
      ...
      before do
        ...
        white_pawn.instance_variable_set(:@game_board, game_board)
        black_pawn.instance_variable_set(:@game_board, game_board)
        white_rook.instance_variable_set(:@game_board, game_board)
        white_knight.instance_variable_set(:@game_board, game_board)
        white_bishop.instance_variable_set(:@game_board, game_board)
      end

      it 'adds first moves to a pawn' do
        white_pawn.instance_variable_set(:@current_coordinate, [0, 1])
      ...
      it 'pawn cant move at all if blocked in first square' do
        ...
        black_pawn.instance_variable_set(:@current_coordinate, [0, 2])
      ...
      it 'adds only one move to pawn that has moved' do
        white_pawn.instance_variable_set(:@current_coordinate, [0, 2])
      ...
      it 'cant move at all if another piece is in front of it' do
        ...
        black_pawn.instance_variable_set(:@current_coordinate, [0, 3])
        black_pawn.instance_variable_set(:@moved, true)
      ...
      it 'adds no moves to new rook that is blocked by pawn and knight' do
        ...
        white_rook.instance_variable_set(:@current_coordinate, [0, 0])
        ...
        white_knight.instance_variable_set(:@current_coordinate, [1, 0])
      ...
      it 'adds moves to a bishop that isnt blocked' do
        ...
        white_bishop.instance_variable_set(:@current_coordinate, [2, 0])
      ...
      it 'adds moves to a knight with pieces in front of it' do
        white_pawn.instance_variable_set(:@current_coordinate, [1, 1])
        white_pawn.instance_variable_set(:@moved, true)
        pawn_start_square = game_board.find_square([1, 1])
        pawn_start_square.occupant = white_pawn

        white_rook.instance_variable_set(:@current_coordinate, [3, 1])
        white_rook.instance_variable_set(:@moved, true)
        rook_start_square = game_board.find_square([0, 0])
        rook_start_square.occupant = white_rook
        ...
        white_bishop.instance_variable_set(:@current_coordinate, [2, 1])
        white_bishop.instance_variable_set(:@moved, true)
        bishop_start_square = game_board.find_square([2, 0])
        bishop_start_square.occupant = white_bishop
        ...
        # p game_board
        white_knight.update_movements_and_attacks
      ...
      it 'adds moves to a bishop when space is occupied by opponent' do
        ...
        black_pawn.instance_variable_set(:@current_coordinate, [6, 4])
        black_pawn.instance_variable_set(:@moved, true)
      ...
      it 'adds moves to a rook when opponents piece is in destination' do
        ...
        black_pawn.instance_variable_set(:@current_coordinate, [0, 5])
        black_pawn.instance_variable_set(:@moved, true)
      ...
      it 'adds moves to a knight when opponents piece is in destination' do
        ...
        black_pawn.instance_variable_set(:@current_coordinate, [3, 1])
        black_pawn.instance_variable_set(:@moved, true)
      ...
      it 'adds attack square to pawn when opponent in range' do
        ...
        black_pawn.instance_variable_set(:@current_coordinate, [1, 2])
        black_pawn.instance_variable_set(:@moved, true)
      ...
      it 'adds attack square to pawn when opponent in range on the other side' do
        white_pawn.instance_variable_set(:@current_coordinate, [1, 1])
        pawn_start_square = game_board.find_square([1, 1])
        pawn_start_square.occupant = white_pawn
        ...
        expected_move_squares = [[1, 2], [1, 3], [0, 2]]
        # p game_board
        white_pawn.update_movements_and_attacks
        expect(white_pawn.instance_variable_get(:@move_squares)).to eq(expected_move_squares)
      end
